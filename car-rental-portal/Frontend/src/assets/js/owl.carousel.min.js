...
!function (a, b, c, d) {
  ...
  e.Defaults = {
    ...
    this.$stage.empty(), this._items = [], b && (b = b instanceof jQuery ? b : a(b)), this.settings.nestedItemSelector && (b = b.find("." + this.settings.nestedItemSelector)), b.filter(brand, "brand").each(a.proxy(function (a, b) {
